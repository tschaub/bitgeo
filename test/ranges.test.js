...
lab.experiment('sortAndMerge()', () => {
  ...
  lab.test('sorts intersections into a flat array of ranges', done => {
  ...
  lab.test('merges adjacent ranges', done => {
  ...
  lab.test('works for point ranges', done => {
...
lab.experiment('or()', () => {
  ...
  lab.test('returns the union of distinct range sets', done => {
  ...
  lab.test('returns the union of overlapping sets', done => {
