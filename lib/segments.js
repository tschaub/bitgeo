...
exports.quantize = function(segments, resolution) {
  ...
  while (segments) {
    ...
    var lowI = Math.round(lowPoint[0] / resolution);
    var lowJ = Math.round(lowPoint[1] / resolution);
    var highI = Math.round(highPoint[0] / resolution);
    var highJ = Math.round(highPoint[1] / resolution);
